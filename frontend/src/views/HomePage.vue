...
// Exhibitors carousel controls (3 items per slide)
const exhibitorsPerSlide = 3
const totalExhibitorSlides = Math.ceil(exhibitors.length / exhibitorsPerSlide)

const nextExhibitorSlide = () => {
  currentExhibitorSlide.value = (currentExhibitorSlide.value + 1) % totalExhibitorSlides
}

const prevExhibitorSlide = () => {
  currentExhibitorSlide.value = (currentExhibitorSlide.value - 1 + totalExhibitorSlides) % totalExhibitorSlides
}
